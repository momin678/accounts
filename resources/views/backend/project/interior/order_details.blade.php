...
<div class="container-fluid invoice-container">
  <div class="row">
    <div class="h5 p-1">Datagate</div>
  </div>
    <div class="row pb-2">
      <div class="col-sm-6"><strong>Date:</strong> 05/12/2020</div>
      <div class="col-sm-6 text-sm-end  text-right"> <strong>Invoice No:</strong> 16835</div>        
    </div>
    <div class="row">
      <div class="col-sm-6 order-sm-0"> <strong>Ordered To:</strong>
        <address>
      ...
      <div class="col-sm-6 text-sm-end order-sm-1 text-right"> <strong>Pay To:</strong>
        <address>
        Name: Koice Inc,<br />
        Phone: 01710101010, <br/>
        Address: 2705 N. Enterprise St<br />
        </address>
      </div>
    </div>
    ...
    <div class="btn-group btn-group-sm d-print-none"> 
      ...
      <a href="{{ route('order-details') }}" class="btn btn-light border text-black-50 shadow-none">PDF Download</a> 
    </div>
    </footer>
  </div>
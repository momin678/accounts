    ...
    <div class="modal-content">
      ...
      <form action="{{route('supplier.store')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-body">
              <div class="form-group">
                <input type="text" name="name" class="form-control" id="recipient-name" placeholder="supplier Name......." required>
              </div>
              <div class="form-group">
                <input type="text" name="shop" class="form-control" id="recipient-name" placeholder="Shop Name......." required>
              </div>
              <div class="form-group">
